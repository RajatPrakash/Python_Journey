# filtering data using panda

import pandas as pd

# data = pd.DataFrame({'Employee_id': [111, 222, 333, 444], 'Employee_name': ['Rajat', 'Prateema', 'Malvika',
# 'Yash'], 'salary': [29000, 32000, 34000, 27000], 'year_of_expr': [2, 4, 5, 6]})

data = pd.DataFrame({'Student_name': ['akash', 'mansi', 'roshan', 'chandu'], 'age': [15, 17, 19, 14], 'subject': ['maths', 'english', 'physics', 'computer science']})
...
print(data.loc[(data['subject'] == 'maths') | (data['subject'] == 'physics')])
